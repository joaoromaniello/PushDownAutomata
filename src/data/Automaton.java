...
public class Automaton {
    ...
    private String initialStackSymbol;     //simbolo inicial da pilha

    public Automaton(List<String> states, String alphabet, List<Rule> rules, String initialState, List<String> finalStates, String StackAlphabet, String initialStackSymbol) {
        this.states = states;
    ...
    public void changeInitialSymbol(String newSymbol) {
        this.initialStackSymbol = newSymbol;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < initialStackSymbol.length(); i++) {
            outputStackInitialSymbol.append(initialStackSymbol.charAt(i));
            if (i != initialStackSymbol.length() - 1) {
